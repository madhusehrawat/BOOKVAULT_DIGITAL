...
const sendOTP = async (email) => {
    ...
    const mailOptions = {
        to: email,
        subject: "OTP Verification - Book Vault",
        html: `
            <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; text-align: center; padding: 30px; border: 1px solid #e0e0e0; border-radius: 12px; max-width: 400px; margin: auto;">
                ...
                <p style="color: #636e72; font-size: 16px;">Please use the following OTP to verify your account at <strong>Book Vault</strong>.</p>
